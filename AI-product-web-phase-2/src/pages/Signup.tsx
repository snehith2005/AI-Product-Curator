...
function SignupForm({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signup(email, firstName.trim(), lastName.trim(), password);
        ...
        <FieldGroup>
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            >
              ...
              <span className="sr-only">AI Product Curator</span>
            </Link>
            <h1 className="text-xl font-bold">AI Product Curator</h1>
            <FieldDescription>
